import type { ProfileStore } from "./globals";
...
declare namespace ProfileService {
	...
	const ProfileResult: RBXScriptSignal<(functionName: string, profileTime: number) => void>;
	let FireProfileResult: boolean;
	 ...
	 */
	const GetProfileStore: <ProfileTemplate extends object, RobloxMetadata = unknown>(
		profileStoreIndex:
			| string
			| {
					/**
